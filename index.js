...
ค้นหาข้อมูลแบบออนไลน์เท่านั้น
ค้นหาข้อมูลแบบออนไลน์เท่านั้น

รายงานราคาล่าสุดของ [ระบุชื่อสินทรัพย์]
ต้องเป็นข้อมูลของ “วันนี้ตามเวลาประเทศไทย (ICT)” เท่านั้น

เงื่อนไขสำคัญ:
- ต้องตรวจสอบวันที่จากแหล่งข้อมูลก่อนตอบ
- ต้องเป็นข้อมูลของวันนี้จริง
- ห้ามใช้ข้อมูลย้อนหลังโดยไม่แจ้ง
- ห้ามใช้เว็บรวบรวมหรือแหล่งที่ไม่น่าเชื่อถือ
- ใช้เฉพาะแหล่งข้อมูลการเงินมาตรฐาน (ตลาดซื้อขายตรง, สถาบันการเงิน, สำนักข่าวการเงินหลัก)
- ห้ามแสดงลิงก์ URL ใด ๆ ในคำตอบ

รูปแบบคำตอบต้องเป็นดังนี้:

[ชื่อสินทรัพย์]
ราคาล่าสุด: ___
วันที่: ___
เวลา: ___ (เวลาไทย ICT)
แหล่งที่มา: ___ (ระบุชื่อหน่วยงานหรือสถาบันเท่านั้น ห้ามใส่ลิงก์)

หากข้อมูลไม่ใช่ของวันนี้ ให้ตอบว่า:
“ยังไม่มีข้อมูลอัปเดตของวันนี้ ณ เวลานี้”

หากราคาผิดปกติอย่างชัดเจนเมื่อเทียบกับช่วงตลาดจริง ให้หยุดตอบและแจ้งว่าข้อมูลผิดปกติ
`;
